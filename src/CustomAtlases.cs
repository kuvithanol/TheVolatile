...
namespace TheVolatile
{
    internal static class CustomAtlases
    {
        ...
        private static FAtlas LoadAtlas(string name)
        {
            ...
            {
                Stream atlasImage = asm.GetManifestResourceStream($"TheVolatile.Atlases.{name}.png");
            ...
            string json;
            {
                Stream atlasJson = asm.GetManifestResourceStream($"TheVolatile.Atlases.{name}.txt");
